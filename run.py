#!/usr/bin/env python3
"""Run ONE problem of sycophancy through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one sycophancy problem via TrustedRouter")
