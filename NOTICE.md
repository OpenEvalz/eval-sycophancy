...
`eval-sycophancy` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/sycophancy`)
...
- `direct_url`: `https://raw.githubusercontent.com/meg-tong/sycophancy-eval/{SHA}/datasets/`
